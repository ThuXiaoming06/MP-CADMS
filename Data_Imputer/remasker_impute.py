...
class ReMasker:
    ...
    def __init__(self):
        ...
        self.path = 'D:/Nature子刊所有材料汇总/NC_rerun_all/data_partition/REMASKer_code/model_save/model5.pth'
    ...
    def fit(self, X_raw: pd.DataFrame):
        ...
        for epoch in range(self.max_epochs):
            ...
            print('epoch {:.0f} | total_loss {:.8f}'.format(epoch, total_loss))
            if total_loss < best_loss:
                 best_loss = total_loss
                 print('!!!Now best_loss is:', best_loss)
